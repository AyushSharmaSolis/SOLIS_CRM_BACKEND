...
const {getCustomLeads,addCustomLeads,updateStatus,getLeadHistroy, acceptLead, getCustomLeadsUpdated} = require('./controller')
...
leadRouter.post('/add',checkToken,addCustomLeads);
 leadRouter.get('/get',checkToken,getCustomLeadsUpdated);
